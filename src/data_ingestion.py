...
class DataIngestion:
    ...
    # Initializing raw_path & ingested_path
    def __init__(self,raw_data_path , ingested_data_dir):
        self.raw_data_path = raw_data_path # raw_data_path se uthana hai data ko aur ingested_data mai store karenge
        self.ingested_data_dir = ingested_data_dir
        logger.info("Data Ingestion has started")

    # Creating Ingested directory
    ...
    def split_data(self,train_path,test_path,test_size=0.2,random_state=42):
        ...
        try:
            ...
            # We are creating 2 csv file one is train & second is test
